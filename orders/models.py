...
class ClientPrice(models.Model):
    ...
    # Индивидуальная цена для этого клиента
    ...
    # Даты для истории (опционально, но полезно)
    ...
    class Meta:
        ...
        # Самая важная часть: ограничение уникальности на уровне СУБД
        unique_together = ('client', 'product')

    def __str__(self):
        return f"Цена для {self.client.name} на {self.product.name}: {self.price} руб."